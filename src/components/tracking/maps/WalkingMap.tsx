// Walking-mode map. Standard light Google map; pulses traveler position in real time.
...
interface Props {
  dealId: string;
  position?: any; // We accept position for consistency with other maps, though we don't use it directly
...
export const WalkingMap: React.FC<Props> = ({
  dealId,
  origin,
  destination,
  travelerAvatar,
    ...
    <View style={[styles.container, style]}>
      ...
      >
        ...
        {pos && (
          ...
          >
            <PulsingDot avatar={travelerAvatar} size={16} color={COLORS.success} />
          </Marker>
        )}
      </MapView>
