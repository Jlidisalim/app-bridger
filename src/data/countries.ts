...
// Source: restcountries.com (public domain)
...
export const COUNTRIES: Country[] = [
  ...
  { name: 'Congo', flag: '🇨🇩', code: 'CD', dialCode: '+243' },
...
export const DEFAULT_COUNTRY = COUNTRIES.find(c => c.code === 'TN') || COUNTRIES[0]; // Default: Tunisia
